//
//  CMDPokemonDetailViewController.m
//  Pokedex
//
...
@interface CMDPokemonDetailViewController ()
...
- (UIColor * _Nullable )pokemonColor;

@end

@implementation CMDPokemonDetailViewController
...
- (void)configureView {
    if (self.pokemon) {
        ...
        if (self.pokemon.type) {
            ...
            [self.view setBackgroundColor:[self pokemonColor]];
        }
    }
}
...
- (void)viewDidLoad {
    ...
    [PokemonAPI.sharedController getDetailsFor:self.pokemon];
    [self configureView];
}
