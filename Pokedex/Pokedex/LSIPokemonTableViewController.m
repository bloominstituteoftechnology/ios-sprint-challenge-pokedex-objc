 ...
 */
 ...
 - (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
     ...
     if ([segue.identifier isEqualToString:@"ShowPokemonSegue"]) {
         NSIndexPath *tableIndexPath = [self.tableView indexPathForSelectedRow];
         LSIDetailViewController *controller = (LSIDetailViewController *)segue.destinationViewController;
         controller.pokemonController = self.pokemonController;
         controller.pokemon = self.pokemon[tableIndexPath.row];
     }
