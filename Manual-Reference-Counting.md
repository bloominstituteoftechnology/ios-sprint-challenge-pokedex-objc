...
2. Which of these objects is autoreleased?  Why?
	...
	1. `NSDate *yesterday = [NSDate date];` // This object is being autorelased becasue the object is not being allocated to memory. 
	...
	6. `LSIPerson *max = [[[LSIPerson alloc] initWithName:@"Max"] autorelease];` This obcjed is being set to autorelease. 
